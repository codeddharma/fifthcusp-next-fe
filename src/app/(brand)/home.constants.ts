...
export const HOME_CONTENT = {
  ...
  aboutUs: {
    ...
    paragraphs: [
      '“The Fifth Cusp is where you learn to hear and understand what the Universe has been telling you all along, how to recognise the messages you’ve been receiving. It is a collective that decodes every cosmic dialect. Your Kundli is your blueprint, your Vastu is your energy grid, your numbers are your signboards, your Aura is your magnetic field, your intentions are your attractor, and together, they show you how the Universe has been communicating with you since the beginning.',
      'The object of our being is simple, we take guidance from Astrology, Numerology, Vastu, Energy Reading, Tarot, Law of Attraction and everything divine to help you take charge of your own life. Karam is what truly changes lives.',
      'Here, you learn how to seek answers from the Universe and how to ask for its gifts. You understand how specific guidance shapes your life, how certain spaces amplify your efforts, why certain timelines propel you years ahead, why certain choices repeat, how a wish becomes creation, and how you can ask the Universe any question and receive clear, direct answers.',
      'The Fifth Cusp teaches you how to translate destiny into direction: where your planets want you to move, how your environment wants to hold you, what your energy is attracting, and how to shift your frequency so creation becomes a state of being rather than effort. As you rise into higher consciousness, you realise the Universe is not outside you, guiding your life; it is within you, speaking through signs, symbols, synchronicities, intuition, and resonance.',
      'The Fifth Cusp is the bridge between your current self and your higher self, the place where everything aligns, communicates, and comes into being.”',
    ],
    fallback:
  ...
  services: {
    title: 'SERVICES',
    subtitle: 'What answers do you really seek? How much do you want to know about yourself ?',
  },
  advancedServices: {
    title: 'ADVANCED SERVICES',
    subtitle: 'Deep-dive offerings for profound transformation',
  },
}
