...
export default function AstrologyHero() {
  const { image, title, titleSanskrit, description } = ASTROLOGY_CONTENT.hero
  ...
  return (
    <section className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1fr_2fr]">
        ...
        <div>
          <h1 className="mb-1 text-4xl font-bold tracking-wide text-white sm:text-5xl">{title}</h1>
          <p className="mb-5 text-lg font-semibold text-[#c4b5fd]">{titleSanskrit}</p>
